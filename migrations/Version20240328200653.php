 ...
 */
final class Version20240328200653 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD roles JSON NOT NULL COMMENT \'(DC2Type:json)\', CHANGE username username VARCHAR(180) NOT NULL');
